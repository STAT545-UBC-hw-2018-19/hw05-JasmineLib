...
- a plotly graph would be useful for a user to scroll/hover and see which countries are where. - plotly can also be useful for being able to zoom in or out to observe trends in local groups of data points.
