...
```
Conclude:
- when using both the arrange() function and the fct_reorder() function, the fct_reorder function takes precedence, even when arrange() is called second.
...
### Part 2: File I/O
Explore read_csv(): 
Use data downloaded from gapminder.org/data
```{r}
